...
- [Update Halloy to 2026.7.2](https://github.com/popey/halloy-snap/pull/21) on [popey/halloy-snap](https://github.com/popey/halloy-snap) (1 week ago)
- [Add initial lines option](https://github.com/popey/slomore/pull/18) on [popey/slomore](https://github.com/popey/slomore) (2 weeks ago)
- [Refresh Repo Assist workflow lock](https://github.com/popey/grummage/pull/46) on [popey/grummage](https://github.com/popey/grummage) (2 weeks ago)
- [Fix visible DMG background helper icons](https://github.com/wimpysworld/sidra/pull/115) on [wimpysworld/sidra](https://github.com/wimpysworld/sidra) (2 weeks ago)
- [Fix Repo Assist auth and lock hash](https://github.com/popey/halloy-snap/pull/15) on [popey/halloy-snap](https://github.com/popey/halloy-snap) (2 weeks ago)
- [Fix Repo Assist scheduled PR check auth](https://github.com/popey/snapupdates/pull/8) on [popey/snapupdates](https://github.com/popey/snapupdates) (2 weeks ago)
- [Fix Repo Assist scheduled PR check auth](https://github.com/popey/mojinav/pull/11) on [popey/mojinav](https://github.com/popey/mojinav) (2 weeks ago)
- [Fix Repo Assist scheduled PR check auth](https://github.com/popey/slomore/pull/12) on [popey/slomore](https://github.com/popey/slomore) (2 weeks ago)
- [Fix Repo Assist scheduled PR check auth](https://github.com/popey/sbom-vm/pull/25) on [popey/sbom-vm](https://github.com/popey/sbom-vm) (2 weeks ago)
- [Fix MAME 0.288 build with Qt 6](https://github.com/popey/mamesnap/pull/14) on [popey/mamesnap](https://github.com/popey/mamesnap) (2 weeks ago)

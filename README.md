...
- [Harden Ubuntu updates and complete the Wayfire path](https://github.com/noughtylinux/config/pull/17) on [noughtylinux/config](https://github.com/noughtylinux/config) (2 weeks ago)
- [Fix DOSBox Staging 0.83.0 runtime resources](https://github.com/popey/dosbox-staging-snap/pull/20) on [popey/dosbox-staging-snap](https://github.com/popey/dosbox-staging-snap) (3 weeks ago)

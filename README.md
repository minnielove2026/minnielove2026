...
- [Harden Ubuntu updates and complete the Wayfire path](https://github.com/noughtylinux/config/pull/17) on [noughtylinux/config](https://github.com/noughtylinux/config) (2 days ago)
